...
{
    $campos=[
        'nombre' => 'required|string|regex:/^[a-zA-Z\s.]+$/|max:60|unique:clientes',
    ...
    $mensaje=[
        ...
        'nombre.regex'=>'El formato del nombre solo acepta letras',
    ...
    public function update(Request $request, $id)
{
    ...
    $todasLasReglas = [
        'nombre' => 'required|string|regex:/^[a-zA-Z\s.]+$/|max:60|unique:clientes,nombre,' . $id,
        'telefono' => 'required|numeric|digits:10',
        'telefono2' => 'nullable|numeric|digits:10',
